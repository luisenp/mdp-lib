...
namespace mlsolvers
{
    ...
    public:
         ...
         *
         * Parameter s0 and return value only kept for compatibiliy
         * with Solver abstract class, they are not used by the
         * method and the return value is always a nullptr.
         *
         */
