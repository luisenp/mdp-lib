...
/**
 * Wrapper of the hash function for action objects
 * (used to define ActionSet below).
 */
struct ActionHash {
...
/**
 * Wrapper of the equality operator for action objects
 * (used to define ActionSet below).
 */
struct ActionEqual {
  bool operator() (Action* a1, Action* a2) const {
    /*
     * Assuming actions can be compared by their address since no
     * new actions are generated after the problem is created.
     */
    return a1 == a2;
  }
};
