#ifndef MDPLIB_RAWFILELEXISTATE_H
#define MDPLIB_RAWFILELEXISTATE_H
...
class RawFileLexiState : public LexiState
{
...
public:
    RawFileLexiState(int id, int nActions, int levels) : id_(id)
    {
     ...
     * probability.
     */
    void addSuccessor(int actionId, RawFileLexiState* succState, double prob);
...
#endif // MDPLIB_RAWFILELEXISTATE_H
