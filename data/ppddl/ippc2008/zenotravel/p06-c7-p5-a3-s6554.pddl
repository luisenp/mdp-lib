...
(define (problem zeno_7_5_3_6554)
  (:domain zenotravel)
  (:objects c0 c1 c2 c3 c4 c5 c6 - city p0 p1 p2 p3 p4 - person a0 a1 a2 - aircraft f0 f1 f2 f3 f4 - flevel)
  (:init (next f0 f1) (next f1 f2) (next f2 f3) (next f3 f4)
         ...
         (at-aircraft a1 c1) (fuel-level a1 f0) (not-refueling a1)
         (at-aircraft a2 c1) (fuel-level a2 f4) (not-refueling a2)
  )
  (:goal (and (at-person p0 c0) (at-person p1 c3) (at-person p2 c0) (at-person p3 c5) (at-person p4 c1)))
  (:goal-reward 10000)
