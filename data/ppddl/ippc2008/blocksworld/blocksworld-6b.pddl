...
(define (problem p01)
  ...
  (:init (emptyhand) (on-table b1) (on-table b2) (on b3 b5) (on b4 b1) (on b6 b2) (on-table b5) (clear b6) (clear b3) (clear b4))
  (:goal (and (emptyhand) (on b1 b3) (on b2 b4) (on-table b3) (on b4 b1) (on b5 b2) (on-table b6) (clear b6) (clear b5)))
  (:goal-reward 1)
