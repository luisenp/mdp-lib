(define (domain schedule)
 ...
 (:constants C0 C1 C2 C3 - class U0 U1 U2 U3 U4 - timestep
...
(:action serve-nothing
  ...
  :effect (and    
              ...
              (not (current-phase Cleanup-and-service))
              (current-phase Arrivals-and-updating))))
  (define (problem a-schedule-problem203)
  (:domain schedule)
  (:objects P0 P1 P2 P3 P4 P5 P6 P7 P8 P9 P10 P11 P12 P13 P14 P15 P16 P17 P18 P19  - packet)   (:init 
         (alive)
         (current-phase Arrivals-and-updating)
