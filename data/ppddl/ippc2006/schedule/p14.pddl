(define (domain schedule)
 ...
 (:constants C0 C1 C2 C3 C4 C5 C6 - class U0 U1 U2 U3 U4 - timestep
...
(:action serve-nothing
  ...
  :effect (and    
              ...
              (not (current-phase Cleanup-and-service))
              (current-phase Arrivals-and-updating))))
  (define (problem a-schedule-problem834)
  (:domain schedule)
  (:objects P0 P1 P2 P3 P4 P5 P6 P7 P8 P9 P10 P11 P12 P13 P14 P15 P16 P17 P18 P19 P20 P21 P22 P23 P24 P25 P26 P27 P28 P29 P30 P31 P32 P33 P34  - packet)   (:init 
         (alive)
         (current-phase Arrivals-and-updating)
