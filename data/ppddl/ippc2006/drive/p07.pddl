...
(define (problem a-drive-problem813)
(:domain drive)
(:objects c0 c1 c2 c3 c4  - coord)
(:init 
       (heading east)
       (at c0 c0)
       (alive)
       ...
       (road-length c3 c3 c3 c4 long)
       (road-length c3 c4 c3 c3 long)
       ...
       (road-length c1 c4 c2 c4 long)
       (road-length c2 c4 c1 c4 long)
       (road-length c2 c4 c3 c4 long)
       (road-length c3 c4 c2 c4 long)
)
(:goal (and (alive) (at c3 c4))))
