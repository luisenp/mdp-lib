...
(:constants  T0 T1 T2 T3 T4 T5 T6 - balltype Easy Medium Hard - difficulty B0 B1 B2 B3 B4 B5 - bit)
(:predicates
  (alive)
...
(:action pitch
 ...
 :effect  (and (thrown)
               ...
               (probabilistic 57/100 (ball-in-the-air-of-type T1))
               (probabilistic 32/100 (ball-in-the-air-of-type T2))
               (probabilistic 52/100 (ball-in-the-air-of-type T3))
               (probabilistic 30/100 (ball-in-the-air-of-type T4))
               (probabilistic 41/100 (ball-in-the-air-of-type T5))
               (probabilistic 23/100 (ball-in-the-air-of-type T6))
               (forall (?B - bit)
                       (probabilistic
...
(define (problem a-pitchcatch-problem868) 
(:domain pitchcatch)  
(:init (alive) 
       (not-thrown)
       (bit-on B0)
       ...
       (difficulty-setting B5 Medium)
       (catchable T0 B4 B0 B1 )
       (catchable T1 B2 B5 B1 )
       (catchable T2 B4 B0 B2 )
       (catchable T3 B4 B0 B3 )
       (catchable T4 B5 B0 B4 )
       (catchable T5 B3 B0 B1 )
       (catchable T6 B4 B0 B3 )
       (similar T6 T1)
       (similar T1 T6)
)
(:goal (and 
