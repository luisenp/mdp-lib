...
(:action pitch
 ...
 :effect  (and (thrown)
               (not (not-thrown))
               (probabilistic 47/100 (ball-in-the-air-of-type T0))
               (probabilistic 18/100 (ball-in-the-air-of-type T1))
               (probabilistic 14/100 (ball-in-the-air-of-type T2))
               (probabilistic 31/100 (ball-in-the-air-of-type T3))
               (probabilistic 39/100 (ball-in-the-air-of-type T4))
               (forall (?B - bit)
                       (probabilistic
...
(define (problem a-pitchcatch-problem329) 
(:domain pitchcatch)  
(:init (alive) 
       (not-thrown)
       (bit-on B0)
       ...
       (catchable T0 B4 B2 B1 )
       (catchable T1 B1 B5 B3 )
       (catchable T2 B1 B2 B5 )
       (catchable T3 B5 B0 B3 )
       (catchable T4 B1 B5 B2 )
       (similar T1 T0)
       (similar T0 T1)
)
(:goal (and 
